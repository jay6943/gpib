...
libsname = 'C:/Program Files/Thorlabs/Kinesis/Thorlabs.MotionControl'
clr.AddReference(f'{libsname}.DeviceManagerCLI.dll')
clr.AddReference(f'{libsname}.GenericMotorCLI.dll')
clr.AddReference(f'{libsname}.IntegratedStepperMotorsCLI.dll')
...
def main():
    ...
    try:
        ...
        # create new device
        serial_no = "45151484"  # Replace this line with your device's serial number
